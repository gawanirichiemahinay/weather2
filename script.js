...
async function UpdateWeatherInfo(city) {
    ...
    updateWeatherVideo(main); // ← integrated background video update
...
function updateWeatherVideo(condition) {
    const video = document.querySelector(".weather-bg-video");
    const body = document.body;

    const conditionToVideo = {
    ...
    const videoSrc = conditionToVideo[condition] || "";
